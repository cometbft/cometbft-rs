...
fn outgoing_fixtures() {
    for json_file in find_fixtures("v1", "outgoing") {
...
fn incoming_fixtures() {
    use cometbft_rpc::event::{v1::DeEvent, EventData};
    ...
    for json_file in find_fixtures("v1", "incoming") {
        let file_name = json_file
            .file_name()
            .unwrap()
            .to_str()
        ...
        match file_name {
            "abci_info" => {
                ...
                assert_eq!(result.response.version, "2.1.0");
            },
            "abci_query_with_existing_key" => {
            ...
            "block_by_hash" => {
                ...
                assert_eq!(
                    ...
                    "582DDEDEAC10340AE0EC8327BA20AB5C9EE98C295AA6721688923325B6C66B0B"
                );
            },
            "block_search" => {
            ...
            "consensus_params" => {
                ...
                assert_eq!(result.consensus_params.block.max_bytes, 4194304_u64);
                assert_eq!(result.consensus_params.block.max_gas, 10000000_i64);
            ...
            "genesis" => {
                ...
                assert_eq!(result.genesis.consensus_params.block.max_bytes, 4194304);
                assert_eq!(result.genesis.consensus_params.block.max_gas, 10000000);
                assert_eq!(
                    result
                        .genesis
                        .consensus_params
            ...
            "status" => {
                ...
                assert_eq!(result.node_info.version.to_string(), "1.0.0");
