...
use cometbft_proto::{
    types::v1::{BlockId as RawBlockId, Header as RawHeader},
...
mod v1 {
    ...
    use cometbft_proto::Protobuf;
    use cometbft_proto::{
        types::v1::Header as RawHeader, version::v1::Consensus as RawConsensusVersion,
    };
...
mod v1beta1 {
    use super::Header;
    use crate::{block, Error};
    use cometbft_proto::types::v1beta1::Header as RawHeader;
    use cometbft_proto::Protobuf;
