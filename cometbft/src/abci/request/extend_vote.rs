...
mod v1 {
    ...
    impl From<ExtendVote> for pb::ExtendVoteRequest {
        fn from(extend_vote: ExtendVote) -> Self {
            Self {
                hash: extend_vote.hash.into(),
                height: extend_vote.height.into(),
    ...
    impl TryFrom<pb::ExtendVoteRequest> for ExtendVote {
        type Error = Error;

        fn try_from(message: pb::ExtendVoteRequest) -> Result<Self, Self::Error> {
            Ok(Self {
                hash: message.hash.try_into()?,
                height: message.height.try_into()?,
                time: message
    ...
    impl Protobuf<pb::ExtendVoteRequest> for ExtendVote {}
}
...
mod v1beta3 {
    ...
    impl TryFrom<pb::RequestExtendVote> for ExtendVote {
        ...
        fn try_from(message: pb::RequestExtendVote) -> Result<Self, Self::Error> {
            Ok(Self {
                hash: message.hash.try_into()?,
                height: message.height.try_into()?,
                time: message
