...
impl Set {
    ...
    /// Sort the validators according to the current CometBFT requirements
...
mod v1 {
    use super::{Info, Set, SimpleValidator, Update};
    use crate::{account, prelude::*, Error};
...
mod v1beta1 {
    ...
    use cometbft_proto::abci::v1beta1::ValidatorUpdate as RawValidatorUpdate;
