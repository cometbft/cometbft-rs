...
- [Part I](#part-i---cometbft-blockchain): Introduction of
...
transactions) from the one generated by CometBFT consensus.
...
generated by the CometBFT consensus. We say *trustedHeader* is verified.

### Temporal Properties

#### **[LCV-DIST-SAFE.1]**:
It is always the case that every verified header in *LightStore* was
generated by an instance of CometBFT consensus.
