...
input a header with some height *h*, connects to different CometBFT
...
designed for the CometBFT failure model (1/3 assumption)
...
header that was not generated by CometBFT consensus.
...
> CometBFT; *b* can be traced back to genesis
...
> [forks][cometbftfork]. Please confirm!  
...
> in the document on [forks][cometbftfork]. However, main chain
> forks were defined more operational "forks that are observed by
> full nodes as part of normal CometBFT consensus protocol". Please
> confirm! 
...
[[cometbftfork]] CometBFT fork detection and accountability
...
[cometbftfork]: https://docs.google.com/document/d/1xjyp5JOPt7QfHem1AFEaowBH2Plk0IHACWtYFXFvO7E/edit#heading=h.th2369ptc2ve
